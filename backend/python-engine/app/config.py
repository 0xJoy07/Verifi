...
class Settings(BaseSettings):
    ...
    # Vision Model (fallback content extraction from images)
    # Uses a free vision-capable model on OpenRouter. Override via LLAMA_VISION_MODEL env var.
    LLAMA_VISION_MODEL: str = "google/gemma-4-26b-a4b-it:free"
